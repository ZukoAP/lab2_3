...
public:
    ...
    void setupUi(QWidget *GraphInteractionWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral("D:\\lab2_3\\resources\\submitIcon.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral("D:\\lab2_3\\resources\\boxIcon.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral("D:\\lab2_3\\resources\\quitIcon.png"), QSize(), QIcon::Normal, QIcon::Off);
